---
sidebar_position: 4
title: UnitClass Script Template
hide_title: true
sidebar-label: 'UnitClass Script Template'
---

Below is a template for a [UnitClass](https://scrapmechanictools.com/lua/Game-Script-Environment/Classes/UnitClass) script, used for running AI for controlling non-player characters.
