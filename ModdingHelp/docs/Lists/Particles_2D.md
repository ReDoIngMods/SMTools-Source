...
Listed below are all 2D particles that can be used with [sm.particle.createParticle](https://scrapmechanictools.com/lua/Game-Script-Environment/Static-Functions/sm.particle#createparticle).
...
These particles are exclusive to challenge mode.

```json
[
	"p_2d_challengemode_approvedbanner_shine",
	"p_2d_challengemode_stuntmanoutfit_backgroundshine"
]
```
