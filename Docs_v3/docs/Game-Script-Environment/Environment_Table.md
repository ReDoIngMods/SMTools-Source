...
While this is not particularly useful for Lua scripting, it is still listed here as it may be helpful to someone developing external C++-based mods for the game.
